# Airport Distance API - Examples

This folder contains example code for using the Airport Distance API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/airportdistance', {
...
var response = await client.GetAsync("https://api.apiverve.com/v1/airportdistance");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/airportdistance](https://docs.apiverve.com/ref/airportdistance)
