...
const (
	baseURL        = "https://api.apiverve.com/v1/airportdistance"
	defaultTimeout = 30 * time.Second
)

// Client is the Airport Distance API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Airport Distance API client.
...
// Execute makes a request to the Airport Distance API with typed parameters.
//
