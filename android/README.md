...
```gradle
dependencies {
    implementation 'com.github.apiverve:airportdistance-api:1.1.14'
}
```
...
```java
import com.apiverve.airportdistance.AirportDistanceAPIClient;
import com.apiverve.airportdistance.APIResponse;
import com.apiverve.airportdistance.APIException;

// Initialize the client
AirportDistanceAPIClient client = new AirportDistanceAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("iata1", "JFK");
    parameters.put("iata2", "LAX");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/airportdistance](https://docs.apiverve.com/ref/airportdistance)
...
- **Documentation:** [https://docs.apiverve.com/ref/airportdistance](https://docs.apiverve.com/ref/airportdistance)
- **Issues:** [GitHub Issues](https://github.com/apiverve/airportdistance-api/issues)
